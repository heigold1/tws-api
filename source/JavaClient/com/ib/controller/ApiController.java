...
import ib.controller.ScannerRequestData; 
...
public class ApiController implements EWrapper {
	...
	private int m_orderId;
        Map<Integer, ScannerRequestData> m_scannerRequestDataMap = new HashMap<Integer, ScannerRequestData>();
    ...
    public int reqTopMktData(NewContract contract, String genericTickList, boolean snapshot, ITopMktDataHandler handler) {
        ...
        // save the market data in a hash 
...
System.out.println("inside reqTopMktData, the reqId one, requestData.m_genericTickList is " + requestData.m_genericTickList); 
    ...
    public NewContract getNewContract(int reqId)
    {
        Integer myInt = reqId; 
        ScannerRequestData scannerRequestData = m_scannerRequestDataMap.get(myInt); 
        
        return scannerRequestData.getNewContract();
    }
	...
	public int reqScannerSubscription( ScannerSubscription sub, IScannerHandler handler) {
		int reqId = m_reqId++;
...
//                 Brent - Dec 30th, 2023
        ...
        public void reReqScannerSubscription(int reqId, ScannerSubscription sub, IScannerHandler handler) {
		Vector<TagValue> scannerSubscriptionOptions = new Vector<TagValue>();
		m_client.reqScannerSubscription( reqId, sub, scannerSubscriptionOptions);
		sendEOM();
	}
...
System.out.println("inside cancelScannerSubscription, reqId is " + reqId); 
